...
export default function IntegrationReactSelect({suggestions, selectedDoc}: {suggestions: OptionType[], selectedDoc: (value: any) => void}) {
    ...
    <div className={classes.root}>
      <NoSsr>
        <Select
          ...
          placeholder="busca por el nombre del docente"
          options={suggestions}
